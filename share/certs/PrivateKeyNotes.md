...
unlocked to sign the Stlcoin-Qt.app bundle.
...
allowing somebody to distribute a Stlcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the stlcoin-qt.exe file inside the installer had not been tampered with.
